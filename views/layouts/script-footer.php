...
<script src="../../vendor/admin/vendor/bootstrap/js/bootstrap.min.js"></script>
    ...
    <script src="../../vendor/admin/vendor/metisMenu/metisMenu.min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="../../vendor/admin/dist/js/sb-admin-2.js"></script>

    <!-- DataTables JavaScript -->
    <script src="../../vendor/admin/vendor/datatables/js/jquery.dataTables.min.js"></script>
